...
public class BookingFlowHappyPathTest extends DriverCapabilities {
    ...
    public void bookingFlowHappyPathTest() throws Exception {
        ...
        if (Platform1.equalsIgnoreCase("Android")) {
            ...
            locationSearchUser.enterLocationAlternative();
            // locationSearchUser.locationSearchPage_Destination_SearchBox.sendKeys("Atlanta
            // TX");
        }
        DriverWait.staticWait();
        ...
        String Query = "UPDATE [Tosca_GRS_TDM].[dbo].[GRS_POC_InputTable] set ConfNumber = '" + confirmationNo_BookingDetailTrim + "' where ScenarioName = 'SP24Stage'";
        ...
        String Query1 = "SELECT ConfNumber FROM [Tosca_GRS_TDM].[dbo].[GRS_POC_InputTable] WHERE ScenarioName = 'SP24Stage'";
        ;
