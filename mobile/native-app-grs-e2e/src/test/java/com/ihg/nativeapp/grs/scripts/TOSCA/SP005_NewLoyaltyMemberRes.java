...
public class SP005_NewLoyaltyMemberRes extends DriverCapabilities {
    ...
    public void findReservation() throws Exception {
        ...
        String screenPlayName = "SP05Stage";
        ...
        /*
         * // Clicking Sign In and expanding account landing page for anonymous // user util.click(homeuser.home_btnSignIn); DriverWait.staticWait();
         *
         * // SignIn into IHG signUser.signInDB(screenPlayName); signUser.handleConfirmationPageAndReachingHome();
         */
