...
public class SP024_CreateDynamicRateProperty extends DriverCapabilities {
    ...
    public void bookingAsGuest() throws Exception {
        ...
        String screenPlayName = "SP24Stage";
        ...
        // Clicking Sign In or Continue As Guest button
        util.click(opcoUser.opco_SignInOrAsGuest);
        ...
        guestInfoAnonymousUser.GuestInfoDB(screenPlayName);
        ...
        // Verifying elements on Reservation Summary Page
